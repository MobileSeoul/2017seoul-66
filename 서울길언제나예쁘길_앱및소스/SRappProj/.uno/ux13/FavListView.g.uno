...
public partial class FavListView: Fuse.Controls.Page
{
    readonly Fuse.Navigation.Router router;
    [Uno.Compiler.UxGenerated]
    public partial class Template: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly FavListView __parent;
        [Uno.WeakReference] internal readonly FavListView __parentInstance;
        public Template(FavListView parent, FavListView parentInstance): base(null, false)
        {
            __parent = parent;
        ...
        {
            var __self = new global::FavEventCard(__parent.contentPlaceholder);
            ...
            __self_RoadId_inst = new SRapp_FavEventCard_RoadId_Property(__self, __selector2);
    ...
    void InitializeUX()
    {
        ...
        temp3.LineNumber = 6;
        temp3.FileName = "List/FavListView.ux";
        temp3.File = new global::Uno.UX.BundleFileSource(import("../../List/FavListView.js"));
